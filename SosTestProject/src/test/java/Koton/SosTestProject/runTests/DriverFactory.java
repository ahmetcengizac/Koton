...
public class DriverFactory {
	...
	final static String GECKO_DRIVER_DIRECTORY = System.getProperty("user.dir") + "/src/test/java/Koton/SosTestProject/resources/geckodriver";
	
	final static String CHROME_DRIVER_DIRECTORY = System.getProperty("user.dir") + "/src/test/java/Koton/SosTestProject/resources/chromedriver";
	
	final static String IE_DRIVER_DIRECTORY = System.getProperty("user.dir") + "/src/test/java/Koton/SosTestProject/resources/IEDriverServer";
